...
namespace Nova.InternalNamespace_0.InternalNamespace_9
{
    ...
    internal partial class InternalType_227 : InternalType_147, IDisposable
    {
        ...
        public void InternalMethod_1077(InternalType_133 InternalParameter_1088, InternalType_131 InternalParameter_1089)
        {
            ...
            InternalMethod_3741(InternalVar_1);
        }
        ...
        public void InternalMethod_3741(InternalType_131 InternalParameter_3523, int InternalParameter_3524 = -1)
        {
            if (!InternalField_601.InternalField_631.TryGetValue(InternalParameter_3523, out InternalType_252 InternalVar_1))
            {
                return;
            }
            ...
            if (InternalParameter_3524 > 0)
            {
                InternalVar_1.InternalField_741 = InternalParameter_3524;
            }
        ...
        private static int InternalMethod_3742(ref InternalType_164<InternalType_131> InternalParameter_3525, ref InternalType_228 InternalParameter_3526)
        {
            int InternalVar_1 = 0;

            for (int InternalVar_2 = 0; InternalVar_2 < InternalParameter_3525.InternalProperty_216; ++InternalVar_2)
            {
                if (InternalParameter_3526.InternalField_632.TryGetValue(InternalParameter_3525[InternalVar_2], out InternalType_133 InternalVar_3))
                {
                    InternalVar_1 += InternalParameter_3526.InternalField_628[InternalVar_3].InternalProperty_253;
                }
            }
        ...
        public int InternalMethod_3743(InternalType_131 InternalParameter_3527)
        {
            if (InternalField_601.InternalField_632.TryGetValue(InternalParameter_3527, out InternalType_133 InternalVar_1))
            {
