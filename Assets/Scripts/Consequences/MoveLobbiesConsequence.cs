    ...
    public class MoveLobbiesConsequence : SwapTransformsConsequence
    {
        ...
        public override void Execute(TriggerData? data)
        {
            ...
            if (bringPlayerAlong)
            {
                ...
                UnityUtil.MoveAndRotatePlayer(toSwap.transform.position - toSwapWith.transform.position,
                    Quaternion.Euler(initialRotation - finalRotation), playerMotor, playerCamera);
            }
        }
        ...
        private void swapDestinations()
        {
            ...
            if (otherConsequence == null)
                throw new NullReferenceException("Elevator car attempting position swap with other elevator car found no TeleportElevatorSwitch/TeleportElevatorUp object");
        ...
        private void chooseElevatorToSwapWith()
        {
            ...
            this.toSwapWith =
                UnityUtil.SelectRandomChild(GameObject.Find(nameOfDestinationLobby).transform
                    .Find("ElevatorLobbyElevators"));
        }
